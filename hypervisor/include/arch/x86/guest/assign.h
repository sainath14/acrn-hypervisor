 ...
 *
 */
void ptirq_intx_ack(struct acrn_vm *vm, uint32_t vgsi, enum intx_ctlr vgsi_ctlr);
 ...
 *
 */
int32_t ptirq_intx_pin_remap(struct acrn_vm *vm, uint32_t virt_pin, enum intx_ctlr vgsi_ctlr);
 ...
 *
 */
void ptirq_remove_intx_remapping(struct acrn_vm *vm, uint32_t virt_gsi, bool pic_pin);
