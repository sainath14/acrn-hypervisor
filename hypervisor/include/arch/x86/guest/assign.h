 ...
 *
 */
int32_t ptirq_intx_pin_remap(struct acrn_vm *vm, uint8_t vioapic_index, uint32_t virt_pin, uint8_t vpin_src);
 ...
 *
 */
int32_t ptirq_add_intx_remapping(struct acrn_vm *vm, uint8_t vioapic_index, uint32_t virt_pin, uint32_t phys_pin, bool pic_pin);
